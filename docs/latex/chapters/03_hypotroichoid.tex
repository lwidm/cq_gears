...
Since we need to move the arrow along the involute \textbf{while keeping the angle w.r.t the involute constant}, we need to continuously rotate this arrow by an angle defined by the involute.
