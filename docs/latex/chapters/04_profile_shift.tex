...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{profile_shift_intuition_YT_screenshot.png}
    \caption{Geometric intuition for profile shift: the cutting rack is displaced parallel to its tooth flank~(\fullcite{undercut_profile_shift_YTvideo}).}
