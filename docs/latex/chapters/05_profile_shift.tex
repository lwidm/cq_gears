...
A detailed explanation of undercut and profile shift can be found in the video by \textcite{undercut_profile_shift_YTvideo} (Timestamp 7:48).
...
\begin{figure}[ht]
    ...
    \caption{Geometric intuition for profile shift: the cutting rack is displaced parallel to its tooth flank. Left:~\textcite{undercut_profile_shift_YTvideo}, Right:~\textcite{profileshift}.}
