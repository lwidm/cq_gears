...
Resulting in:
\begin{equation}
    s_0 = \frac{m\pi}{2} + 2 \cdot n \cdot x \cdot \tan(\alpha_n)
\end{equation}
Therefore, the angle spanned by half of the tooth at the pitch circle is:
\begin{align}
    \gamma_0    &= \frac{s_0}{d_p} \\
                &= \frac{1}{d_p}\left(\frac{m\pi}{2} + 2 \cdot n \cdot x \cdot \tan(\alpha_n)\right) \\
                &= \frac{m\pi + 4 \cdot n \cdot x \cdot \tan(\alpha_n)}{2\,d_p}
\end{align}
...
\begin{align}
    \gamma &= \gamma_0+\Delta \gamma \\
           &= \frac{m\pi + 4 \cdot n \cdot x \cdot \tan(\alpha_n)}{2\,d_p} + \left[\left(\frac{d_p}{d_b}\right)^2 - 1\right]^{\tfrac{1}{2}} - \arctan\left(\left[\left(\frac{d_p}{d_b}\right)^2 - 1\right]^{\tfrac{1}{2}}\right)
\end{align}
\end{subequations}
