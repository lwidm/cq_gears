\section{Spur and Helical Spur Gears}
...
The construction in this section is identical for spur and helical spur gears: the tooth profile is built in the transverse plane (perpendicular to the gear axis) using the transverse pressure angle $\alpha_t$ and transverse module $m_t$. For helical gears these are derived from the standardised normal-section inputs $\alpha_n$, $m_n$ and helix angle $\beta$ using the conversions in Section~\ref{subsec:helical_conversions}. Spur gears are simply the $\beta = 0$ special case for which $\alpha_t = \alpha_n$ and $m_t = m_n$, so no conversion is needed. The only difference between the two cases is the extrusion of the 2D tooth profile into the third dimension (straight extrude for spur, helical sweep for helical).
...
\begin{figure}[ht]
    ...
    \caption{Gemetric description of additional tooth width due to profile shift. Here \mbox{$V:=x\cdot m$, the absolute profile shift value}. (\textcite{profileshift})}
...
\begin{subequations}
\begin{align}
    \Delta s    &= 2 \cdot V \cdot \tan(\alpha_n) \\
                &= 2 \cdot m \cdot x \cdot \tan(\alpha_n)
\end{align}
\end{subequations}
...
\begin{align}
    s_0 &= \frac{p_0}{2} + \Delta s \\
        &= \frac{m\pi}{2} + 2 \cdot m \cdot x \cdot \tan(\alpha_n) \\
        &= \frac{m}{2}\left(\pi + 4 \cdot x \cdot \tan(\alpha_n)\right)
\end{align}
\end{subequations}
...
\begin{align}
    \gamma_0    &= \frac{s_0}{d_p} \\
                &= \frac{m\left(\pi + 4 \cdot x \cdot \tan(\alpha_n)\right)}{2\,d_p}
\end{align}
\end{subequations}
...
\begin{align}
    \gamma &= \gamma_0+\Delta \gamma \\
           &= \frac{m\left(\pi + 4 \cdot x \cdot \tan(\alpha_n)\right)}{2\,d_p} + \left[\left(\frac{d_p}{d_b}\right)^2 - 1\right]^{\tfrac{1}{2}} - \arctan\left(\left[\left(\frac{d_p}{d_b}\right)^2 - 1\right]^{\tfrac{1}{2}}\right)
\end{align}
\end{subequations}
...
\begin{align}
    ...
    \gamma &= \frac{m\left(\pi + 4 \cdot x \cdot \tan(\alpha_n)\right)}{2\,d_p} + \left[\left(\frac{d_p}{d_b}\right)^2 - 1\right]^{\tfrac{1}{2}} - \arctan\left(\left[\left(\frac{d_p}{d_b}\right)^2 - 1\right]^{\tfrac{1}{2}}\right)
\end{align}
